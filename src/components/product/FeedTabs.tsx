...
type FeedTag = 'For You' | 'Following'

interface Props {
  value?: FeedTag
  onChange?: (tab: FeedTag) => void
}
const FeedTabs = ({ value, onChange }: Props) => {
  const [internal, setInternal] = useState<FeedTag>('For You')
  const selected = value ?? internal

  const tabs: FeedTag[] = ['For You', 'Following']
